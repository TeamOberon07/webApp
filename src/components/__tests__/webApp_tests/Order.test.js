import { fireEvent,createEvent, getByRole, render, screen } from "@testing-library/react";
import { BrowserRouter } from "react-router-dom";
import { Orders, copyAddress } from "../../Orders";
...
describe('Orders',
    () => {
        test("TU11 visualizzazione delle transazioni (isBuyer = true)",async () => {
        ...
        test("TU11 visualizzazione delle transazioni (isBuyer = false)", async () => {
