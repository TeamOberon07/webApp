...
describe("RegisterSeller", () => {
    test("TU09 RegisterSeller standard behaviour", () => {
    ...
    test("TU10 RegisterSeller Switch Network", () => {
    ...
    test("TU11 RegisterSeller No Metamask", async () => {
    ...
    test("TU12 RegisterSeller No Wallet", () => {
